...
hdvideoQuery(document).ready(function() {
     ...
     * Disabled for now...
        ...
        post_box.before(hdvideo_add_buttons_code);
    ...
    */
    ...
    hdvideoQuery('.hdvideo_add_comment').click(function () {
        ...
        if (hdvideoQuery(this).hasClass('video')) {
            recorder_container.html('<br><br><a href="#" class="hdvideo_hide_recorder_container" style="display:block;padding-left:'+rwidth1+'px" align="center">' + hdvideoL10N['close_recorder_link'] + '</a>\
<embed id="recorder" src="'+site_url+'/wp-content/plugins/'+cvc+'/recorder.swf" name="recorder" allowscriptaccess="always" allowfullscreen="true" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" align="middle" width="'+rwidth+'" height="'+rheight+'" flashvars="server='+serverpath+'&url=' + encodeURIComponent(location.href) + '&config='+site_url+'/wp-content/plugins/'+cvc+'/config.xml&maxduration='+maxduration+'&license='+license+'&post_title=' + encodeURIComponent(document.title) + '"></embed><br><br>');
        }
    ...
    */
    ...
    hdvideoQuery('a').each(function () {
        ...
        var url_re = /http\:\/\/([a-z0-9]{19})\#(video)/; //
        ...
        if (matches != null) {
            ...
            if (hdvideo_type == 'video') {
                thumbnail_image = site_url+'/wp-content/plugins/'+cvc+'/images/'+hdvideo_id+'.jpg';
            }

            var hdvideo_view_comment_code = '<div id="hdvideo_player_' + hdvideo_instance + '"> \
                </div> \
                <div class="hdvideo_player_link" align="center" id="hdvideo_player_' + hdvideo_instance + '_link"> \
    ...
    hdvideoQuery('.hdvideo_play_comment').click(function () {
        ...
        if (hdvideo_type == 'video') {
             thumbnail_image = site_url+'/wp-content/plugins/'+cvc+'/images/'+hdvideo_id+'.jpg';
             embed_code= '<embed wmode="opaque" src="'+site_url+'/wp-content/plugins/'+cvc+'/recorder.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" flashvars="config='+site_url+'/wp-content/plugins/'+cvc+'/config.xml&server='+serverpath+'&license='+license+'&filename='+hdvideo_id+'&mode=player&preview='+thumbnail_image+'"  width="'+pwidth+'" height="'+pheight+'"></embed>';
        }
        var rwidth2= (rwidth/1);
        hdvideo_player_container.html('<div class="hdvideo_player_container" align="center"> <a href="#" class="hdvideo_close_player_link" style="display:block;padding-left:'+rwidth2+'px" id="hdvideo_close_player_link_' + hdvideo_instance + '">' + hdvideoL10N['close_player_link'] + '</a>' + embed_code + '</div>');
